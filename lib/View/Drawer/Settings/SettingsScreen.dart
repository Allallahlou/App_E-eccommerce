...
import 'package:app_e_ecommerce/View/Drawer/Settings/AllSettings/AllSettingsScreen.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSettingsOption(
                ...
                text: isEnglish ? "Admin Settings " : "إعدادات المسؤول",
                onTap: () {
            ...
            _buildSettingsOption(
                icon: Icons.store,
                text: isEnglish ? "All Settinge " : " جميع الإعدادات",
                onTap: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const AllSettingsScreen(),
                    ),
                  );
                })
          ],
